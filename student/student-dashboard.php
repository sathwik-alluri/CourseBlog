...
$regd = $_SESSION['regd'];
 ...
 $sql="SELECT  register_number,	name ,dob,gmail, phone_number,	batch,	department,	gender,`cgpa`,	current_year FROM students where register_number='$regd' ";
        ...
        <div class="wrapper">
            ...
            <div class="content-page">
                <div class="content">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="avatar-lg">
                                                            <img src="assets/images/users/default.avif" alt="" class="rounded-circle img-thumbnail">
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div>
                                                            <h4 class="mt-1 mb-1 text-white">Welcome !!</h4>
                                                            <!-- <p class="font-13 text-white-50"> Authorised Brand Seller</p> -->
    
                                                            <ul class="mb-0 list-inline text-light">
                                                                <li class="list-inline-item me-3">
                                                                    <h5 class="mb-1 text-white" style="text-align:center"><?php
                                                            
                                                            echo $_SESSION['regd'];?> </h5>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="text-center mt-sm-0 mt-3 text-sm-end">
                                                    <button type="button" class="btn btn-light" action="edit.php">
                                                        <a href="edit.php"><i class="mdi mdi-account-edit me-1"></i> Edit Profile</a>
                                                    </button>
                                                </div>
                                            </div> <!-- end col-->
                                        </div> <!-- end row -->
                    ...
                    $s_dob=$row['dob'];
                    $s_mail=$row['gmail'];
                    $s_mobile=$row['phone_number'];
                    $s_batch=$row['batch'];
                    $s_dept=$row['department'];
                    $s_gender=$row['gender'];
                    $s_cgpa=$row['cgpa'];
                    }                  
?>
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mt-0 mb-3">Student Details</h4>
                                        ...
                                        <div class="text-start">
                                            <p class="text-muted"><strong>Full Name :</strong> <span class="ms-2"><?php echo $s_name ; ?></span></p>

                                            <p class="text-muted"><strong>Reg. Number :</strong><span class="ms-2"><?php echo $reg_num;?></span></p>

                                            <p class="text-muted"><strong>Mobile :</strong><span class="ms-2"><?php echo $s_mobile;?></span></p>

                                            <p class="text-muted"><strong>Email :</strong> <span class="ms-2"><?php echo $s_mail; ?></span></p>

                                            <p class="text-muted"><strong>Gender :</strong><span class="ms-2"><?php echo $s_gender ; ?></span></p>

                                            <p class="text-muted"><strong>Branch:</strong> <span class="ms-2"><?php echo $s_dept ; ?></span></p>

                                            <p class="text-muted"><strong>Year :</strong>
                                                <span class="ms-2"><?php echo $s_batch; ?> </span>
                                            </p>
                                            <p class="text-muted"><strong>Cgpa :</strong>
                                                <span class="ms-2"><?php echo $s_cgpa;?> </span>
                                            </p>
